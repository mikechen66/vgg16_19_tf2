...
"""
It is the OOP style VGG19 model without the main function. Please notify that the class
AlexNet has no return value(or None). However, the outer function Vgg19() can call the 
...
# show the full model structure of Vgg19 
model.summary()
