...
"""
The script is the self-consistent realization of object-oriented programming  of the VGG19 model with 
...
numbers. Users can use the typical dot syntax to call the VGG19 model. 
...
class Vgg19(Sequential):
    ...
    # Adopt the static method to enbale the explicit "return model"  
    @staticmethod
...
if __name__ == '__main__':
    ...
    # Use the model to call the function of build() in the Vgg19 class with the dot syntax
    model = Vgg19().build(input_shape, num_classes)
